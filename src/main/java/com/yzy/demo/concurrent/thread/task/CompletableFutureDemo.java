package com.yzy.demo.concurrent.thread.task;
...
public class CompletableFutureDemo
{
   ...
   { 
      try
      {
         ...
         System.out.println("Found IMAGE URLs: " + result);
         return result;
      }
      catch (IOException e)
      {
   ...
   {
      urlToProcess = url;
      // use completedFuture(url) rather than calling readPage directly, this way, the pipeline has a very uniform
      // appearance
   ...
   public static void main(String[] args) 
         throws IOException, InterruptedException
   {
      new CompletableFutureDemo().run(new URL("https://www.12306.cn/index/"));
   }
}
